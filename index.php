...
<div class="container">
  ...
  <form action="registrar.php">
    ...
    <button type="submit" class="btn btn-default" name="enviar" value="enviar">Submit</button>
					</form>
				</div> 
			</div>  
<!-- twiter -->
<div class="row">
	<div class="col-md-3">
		<div style="position:fixed;left:79.1%;"> 
			<a class="twitter-timeline"  href="https://twitter.com/hashtag/ecologico" data-widget-id="912648408506257408">Tweets sobre #ecologico</a>
