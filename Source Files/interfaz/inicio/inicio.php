						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title">Inicio de sesi贸n</h4>
								</div>
								<div class="modal-body">
									<form name="encuesta" action="validacion.php" method="POST"
										...
										<div class="checkbox">
											<label><input type="checkbox"> Recordarme en esta p谩gina</label>
										</div>
    ...
    ?>
			...
			<div class="col-sm-4">
				...
				<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModalRegistro" style="width: 100%; background-color: #01DF74">
                  <span class="glyphicon glyphicon-leaf"></span> <b>Reg铆strate en nuestra p谩gina</b>
                </button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="registro.php" method="POST">
          ...
          <div class="form-group">
            <label for="pwd">Contrase馻:</label>
            <input type="password" class="form-control" name="contrasena" id="contrase馻" required="required"/>
          </div>
          <div class="form-group">
            <label for="pwd">Repite la contrase馻:</label>
            <input type="password" class="form-control" name="contrasenaComprobacion" id="contrase馻Comprobacion" required="required"/>
          </div>
          <button type="submit" class="btn btn-default">Enviar</button>
        </form>
      </div>
				...
				<div class="row">
					<div>
						<a class="twitter-timeline"
							...
							data-widget-id="912648408506257408">Tweets sobre #ecol贸gico</a>
		...
		<footer>
			<div class="container-fluid">
				<div class="row" style="background-color: #E6E6E6;">
					...
					<div class="col-sm-3">
						<h4 style="color: 7ac043;">Informaci贸n</h4>
						<ul style="color: 7ac043">
							<li>Aviso legal</li>
							<li>Preguntas frecuentes</li>
							<li>Trabaja con nosotros</li>
							<li>Env铆os y devoluciones</li>
						</ul>
					</div>

					<div class="col-sm-3">
						<h4 style="color: 7ac043">Con贸cenos</h4>
						<ul>
