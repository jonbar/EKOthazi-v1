	...
	<header>
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-sm-4" style="background-color: lavender;">Quienes
					somos</div>
				<div class="col-sm-4" style="background-color: lavender;">Noticias</div>
				<div class="col-sm-4" style="background-color: lavender;">Productos</div>
			</div>
		</div>
	</header>
</body>
...
<a class="twitter-timeline" href="https://twitter.com/hashtag/ecologico"
...
<div class="col-md-4">
<div class="thumbnail">
<a href="EcoMarketing-logo-1-300x300.PNG" target="_blank">
<img src="EcoMarketing-logo-1-300x300.PNG" style="width:50%">
<div class="caption">
<p></p>
</div>
</a>
